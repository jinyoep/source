...
// ####################################################################################### useEffect End
    ...
    const header = <div  >
      ...
      {showSearchInput && <Tooltip title={i18n['download']}><Input
        ...
        {showExpandBtn && <Tooltip title={i18n[collapsed ? 'expand' : 'collapse']}>
          <>
